...
func (t *Ts3Client) SendGM(ctx context.Context, message string) bool {
	...
	req.Header.Add("X-Api-Key", t.Config.ApiKey)
...
func (t *Ts3Client) ClientListWithTimes(
	ctx context.Context,
) Ts3ClientListResponseWithTimes {
	req, err := http.NewRequestWithContext(ctx, "POST",
...
func (t *Ts3Client) MoveClient(ctx context.Context, clid, cid int) bool {
	req, err := http.NewRequestWithContext(ctx, "POST",
